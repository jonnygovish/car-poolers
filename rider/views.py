...
def driver_profile(request,driver_profile_id,trip_plan_id):  
  ...
  if user:
    ...
    if len(existing_bookings) < trip_plan.driver_profile.car_capacity:
      ...
      return render(request,'riders/driver_profile.html',{'driver_profile': driver_profile,"seats_left":seats_left,"trip_plan":trip_plan})
    elif len(existing_bookings) == trip_plan.driver_profile.car_capacity:
      message = "this ride is fully booked"
      return render(request,'riders/driver_profile.html',{'driver_profile': driver_profile,"message":message})
